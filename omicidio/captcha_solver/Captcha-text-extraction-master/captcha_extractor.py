...
if __name__ == '__main__':
    ...
    args = {"model": "captcha_extractor_model.hdf5",
            "labels": "captcha_labels",
            # "input": "test_sample_captcha.png",
            "input": 'C:/Users/Laurens_laptop_w/Downloads/captcha.jpg',
            "output": "",
        }
...
# find the contours
contours, _, _ = cv2.findContours(thresh.copy(), cv2.RETR_EXTERNAL, cv2.CHAIN_APPROX_SIMPLE)
...
for letter_bounding_box in letter_image_regions:
    ...
    letter_image = gray[max(0, y - 2):y + h + 2, max(0, x - 2):x + w + 2]
